...
Studio's [added-service display](ROUTE-LINE.md#added-service) is separate from routing admission. A reported trip can appear in the line view and trip selector without being available to Route.
