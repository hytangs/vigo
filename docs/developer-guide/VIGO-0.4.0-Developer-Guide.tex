...
VIGO 0.4.0 requires Node.js 24.18 or newer, npm 11.6 or newer, and the pinned Rust toolchain for source builds. Native targets are macOS Apple Silicon/Intel, Linux ARM64/x64 with glibc, and Windows x64. Install the matching runtime; complete City data can move between these targets.
...
The abstraction is stable; support in 0.4.0 is deliberately narrower:

\begin{center}
\begin{tabularx}{\linewidth}{P{1.42in} Z Z Z Y}
\toprule
\textbf{State} & \textbf{Route} & \textbf{Matrix} & \textbf{Reach} & \textbf{Available in 0.4.0} \\
\midrule
...
\field{--objective} & \code{earliest\_arrival} in 0.4.0. \\
