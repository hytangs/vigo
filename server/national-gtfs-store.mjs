...
// The version string alone is not an admission contract: early v1 files can
// predate tables and covering indexes that the current exact router requires.
// Keep this declaration beside the schema version so builders and readers
// cannot silently drift into different meanings of "v1".
const routingStoreTableContract = Object.freeze({
  metadata: Object.freeze(['key:TEXT:0:1:0', 'value:TEXT:1:0:0']),
  stops: Object.freeze([
    'stop_id:TEXT:0:1:0', 'name:TEXT:1:0:0', 'lat:REAL:0:0:0',
    'lon:REAL:0:0:0', 'parent_station:TEXT:0:0:0',
    'location_type:INTEGER:0:0:0', 'platform_code:TEXT:0:0:0',
  ]),
  routes: Object.freeze([
    'route_id:TEXT:0:1:0', 'short_name:TEXT:0:0:0',
    'long_name:TEXT:0:0:0', 'route_type:INTEGER:0:0:0', 'color:TEXT:0:0:0',
  ]),
  trips: Object.freeze([
    'trip_id:TEXT:0:1:0', 'route_id:TEXT:1:0:0',
    'service_id:TEXT:1:0:0', 'direction_id:TEXT:0:0:0',
  ]),
  route_services: Object.freeze([
    'source_scope:TEXT:1:1:0', 'route_type:INTEGER:1:2:0',
    'service_key:TEXT:1:3:0', 'representative_route_id:TEXT:1:0:0',
    'short_name:TEXT:0:0:0', 'long_name:TEXT:0:0:0', 'color:TEXT:0:0:0',
    'variant_count:INTEGER:1:0:0', 'trip_count:INTEGER:1:0:0',
  ]),
  trip_shapes: Object.freeze(['trip_id:TEXT:0:1:0', 'shape_id:TEXT:1:0:0']),
  shape_points: Object.freeze([
    'shape_id:TEXT:1:1:0', 'sequence:INTEGER:1:2:0',
    'lat:REAL:1:0:0', 'lon:REAL:1:0:0',
  ]),
  calendar: Object.freeze([
    'service_id:TEXT:0:1:0', 'monday:INTEGER:0:0:0',
    'tuesday:INTEGER:0:0:0', 'wednesday:INTEGER:0:0:0',
    'thursday:INTEGER:0:0:0', 'friday:INTEGER:0:0:0',
    'saturday:INTEGER:0:0:0', 'sunday:INTEGER:0:0:0',
    'start_date:INTEGER:0:0:0', 'end_date:INTEGER:0:0:0',
  ]),
  calendar_dates: Object.freeze([
    'service_id:TEXT:1:1:0', 'date:INTEGER:1:2:0',
    'exception_type:INTEGER:1:0:0',
  ]),
  transfers: Object.freeze([
    'from_stop_id:TEXT:1:1:0', 'to_stop_id:TEXT:1:2:0',
    'transfer_type:INTEGER:0:0:0', 'min_transfer_time:INTEGER:0:0:0',
  ]),
  frequencies: Object.freeze([
    'trip_id:TEXT:1:0:0', 'start_time:INTEGER:1:0:0',
    'end_time:INTEGER:1:0:0', 'headway_secs:INTEGER:1:0:0',
    'exact_times:INTEGER:0:0:0',
  ]),
  connections: Object.freeze([
    'departure:INTEGER:1:0:0', 'arrival:INTEGER:1:0:0',
    'trip_id:TEXT:1:1:0', 'route_id:TEXT:1:0:0',
    'service_id:TEXT:1:0:0', 'direction_id:TEXT:0:0:0',
    'from_stop_id:TEXT:1:0:0', 'to_stop_id:TEXT:1:0:0',
    'stop_sequence:INTEGER:1:2:0',
  ]),
  // CREATE TABLE AS preserves these affinities in every current builder output.
  stop_modes: Object.freeze([
    'stop_id::0:0:0', 'route_type:INT:0:0:0', 'departure_count::0:0:0',
  ]),
  stop_access_roles: Object.freeze([
    'stop_id:TEXT:1:1:0', 'can_board:INTEGER:1:0:0', 'can_alight:INTEGER:1:0:0',
  ]),
})
const routingStoreWithoutRowidTables = Object.freeze(new Set([
  'route_services',
  'shape_points',
  'connections',
  'stop_access_roles',
]))
const routingStoreMetadataMaxRows = 256
const routingStoreMetadataMaxKeyBytes = 256
const routingStoreMetadataMaxValueBytes = 1024 * 1024
const routingStoreMetadataMaxTotalBytes = 4 * 1024 * 1024
const routingStoreIndexContract = Object.freeze({
  calendar_dates_date: Object.freeze({
    table: 'calendar_dates',
    unique: false,
    columns: Object.freeze(['date:0:BINARY', 'exception_type:0:BINARY']),
  }),
  connections_from_departure_cover: Object.freeze({
    table: 'connections',
    unique: false,
    columns: Object.freeze([
      'from_stop_id:0:BINARY', 'departure:0:BINARY', 'service_id:0:BINARY',
      'trip_id:0:BINARY', 'stop_sequence:0:BINARY', 'arrival:0:BINARY',
      'to_stop_id:0:BINARY',
    ]),
  }),
  route_services_representative: Object.freeze({
    table: 'route_services',
    unique: false,
    columns: Object.freeze(['representative_route_id:0:BINARY']),
  }),
  route_services_trip_rank: Object.freeze({
    table: 'route_services',
    unique: false,
    columns: Object.freeze([
      'source_scope:0:BINARY', 'trip_count:1:BINARY',
      'route_type:0:BINARY', 'service_key:0:BINARY',
    ]),
  }),
  routes_service_identity: Object.freeze({
    table: 'routes',
    unique: false,
    columns: Object.freeze([
      'route_type:0:BINARY', '<expression>:0:BINARY', 'route_id:0:BINARY',
    ]),
    normalizedSql: "createindexroutes_service_identityonroutes(route_type,lower(coalesce(nullif(trim(short_name),''),nullif(trim(long_name),''),route_id)),route_id)",
  }),
  stop_modes_stop_type: Object.freeze({
    table: 'stop_modes',
    unique: true,
    columns: Object.freeze(['stop_id:0:BINARY', 'route_type:0:BINARY']),
  }),
  stop_modes_type_stop: Object.freeze({
    table: 'stop_modes',
    unique: false,
    columns: Object.freeze(['route_type:0:BINARY', 'stop_id:0:BINARY']),
  }),
  stops_lat_lon: Object.freeze({
    table: 'stops',
    unique: false,
    columns: Object.freeze(['lat:0:BINARY', 'lon:0:BINARY']),
  }),
  stops_parent: Object.freeze({
    table: 'stops',
    unique: false,
    columns: Object.freeze(['parent_station:0:BINARY']),
  }),
  transfers_from: Object.freeze({
    table: 'transfers',
    unique: false,
    columns: Object.freeze(['from_stop_id:0:BINARY']),
  }),
  trip_shapes_shape: Object.freeze({
    table: 'trip_shapes',
    unique: false,
    columns: Object.freeze(['shape_id:0:BINARY', 'trip_id:0:BINARY']),
  }),
  trips_route: Object.freeze({
    table: 'trips',
    unique: false,
    columns: Object.freeze(['route_id:0:BINARY', 'trip_id:0:BINARY']),
  }),
  trips_service: Object.freeze({
    table: 'trips',
    unique: false,
    columns: Object.freeze(['service_id:0:BINARY']),
  }),
})
const staticTopologySchemaVersion = 'vigo.routing.static-topology.v3'
const staticTopologySourceFingerprintVersion = 'vigo.routing.static-topology-source.v2'
...
const nationalRoutingAccessPolicyIdentity = crypto.createHash('sha256')
...
const nationalInteractiveRoutingPreference = 'balanced'
export function resolveNationalInteractiveRoutingPreference(value) {
  return value === 'fastest' ? 'fastest' : nationalInteractiveRoutingPreference
}
...
const routeResultCacheLimits = Object.freeze({
  maxEntries: 128,
  maxSegments: 250_000,
...
export class WeightedLruCache {
  constructor({ maxEntries, maxSegments, maxBytes }) {
  ...
  set(key, value, weight = {}) {
    ...
    this.values.set(key, value)
    this.weights.set(key, { segments, bytes })
  ...
  delete(key) {
    ...
    const weight = this.weights.get(key) ?? { segments: 0, bytes: 0 }
    this.values.delete(key)
    this.weights.delete(key)
    this.segments -= weight.segments
    this.estimatedBytes -= weight.bytes
    return true
  }
...
function estimateRoutePlanWeight(plan) {
  let bytes = 2_048
  let coordinatePoints = 0
  for (const leg of plan?.legs ?? []) {
    bytes += 512
    for (const field of ['fromName', 'toName', 'fromStopId', 'toStopId', 'routeId', 'routeShortName', 'tripId']) {
      bytes += String(leg?.[field] ?? '').length * 2
    }
    const coordinates = Array.isArray(leg?.coordinates) ? leg.coordinates : []
    coordinatePoints += coordinates.length
    bytes += coordinates.length * 32
  }
  return { segments: coordinatePoints, bytes }
}
...
function cachedNativeStreetPath(
  ...
  if (diagnostics?.disableCache === true) {
    ...
    if (diagnostics) diagnostics.queryMs += Number(pathResult.nativeQueryMs ?? 0)
...
function routeResultCacheDiagnostics(store) {
  return store.routeResultCache.snapshot()
}
...
const volatilePlanIdentityKeys = new Set([
  'nativeStreetQueryMs',
])
...
function stablePlanId(prefix, payload) {
  return `${prefix}-${crypto.createHash('sha256').update(
    stablePlanIdentityJson(payload),
...
function stableNationalTransitPlanId({
  store,
  streetStorageIdentity,
  serviceDate,
  departMinutes,
  ...
  // Cache identities bind the live files, but they also include build-time
  // metadata. Plan IDs are semantic: identical GTFS content rebuilt at a
  // different time must keep the same itinerary identity. Hash stable source
  // and transfer fingerprints plus the actual choices and timings, not
  // duplicated shape coordinates or volatile native timing diagnostics.
  const transitSourceIdentity = {
    contentFingerprint: store.sourceContentFingerprint ?? null,
    topologyFingerprint: store.sourceFingerprint ?? null,
  ...
  return `national-${crypto.createHash('sha256').update(identity).digest('hex').slice(0, 20)}`
}
...
function admitNationalRoutingStore(db, storePath) {
  ...
  const requiredTableNames = Object.keys(routingStoreTableContract)
  ...
  const requiredIndexNames = Object.keys(routingStoreIndexContract).filter((name) => (
  ...
  for (const tableName of requiredTableNames) {
    ...
    const withoutRowid = normalizedSchemaSql(object.sql).endsWith('withoutrowid')
    if (withoutRowid !== routingStoreWithoutRowidTables.has(tableName)) {
      throw routingStoreAdmissionError(
        storePath,
        'table_storage_mismatch',
        `Table "${tableName}" has the wrong row-storage contract.`,
      )
    }
  }

  const tableValues = requiredTableNames.map(() => '(?)').join(',')
  let tableColumnRows
  try {
    tableColumnRows = db.prepare(`
      WITH required(name) AS (VALUES ${tableValues})
      SELECT required.name AS table_name, column.cid, column.name, column.type,
        column."notnull" AS not_null, column.pk, column.hidden
      FROM required
      JOIN pragma_table_xinfo(required.name) AS column
      ORDER BY required.name, column.cid
    `).all(...requiredTableNames)
  } catch (error) {
    throw routingStoreAdmissionError(
      storePath,
      'table_schema_unreadable',
      `SQLite could not inspect required table columns (${error instanceof Error ? error.message : String(error)}).`,
    )
  }
  const columnsByTable = new Map(requiredTableNames.map((name) => [name, []]))
  for (const column of tableColumnRows) {
    columnsByTable.get(String(column.table_name))?.push(
      `${String(column.name)}:${String(column.type ?? '').toUpperCase()}:${Number(column.not_null)}:${Number(column.pk)}:${Number(column.hidden)}`,
    )
  }
  for (const [tableName, expectedColumns] of Object.entries(routingStoreTableContract)) {
    ...
    if (
      ...
      throw routingStoreAdmissionError(
        ...
        `Table "${tableName}" columns are ${JSON.stringify(actualColumns)}; expected ${JSON.stringify(expectedColumns)}.`,
      )
    }
  }

  for (const [indexName, contract] of Object.entries(routingStoreIndexContract)) {
    ...
    if (object.type !== 'index' || object.tbl_name !== contract.table) {
      throw routingStoreAdmissionError(
        storePath,
        'required_index_wrong_target',
        `Required index "${indexName}" resolves to ${object.type}:${object.tbl_name}; expected index:${contract.table}.`,
      )
    }
    const normalizedSql = normalizedSchemaSql(object.sql)
    const unique = normalizedSql.startsWith('createuniqueindex')
    if (unique !== contract.unique || normalizedSql.includes('where')) {
      throw routingStoreAdmissionError(
        storePath,
        'index_definition_mismatch',
        `Index "${indexName}" has the wrong uniqueness or partial-index contract.`,
      )
    }
    if (contract.normalizedSql && normalizedSql !== contract.normalizedSql) {
      throw routingStoreAdmissionError(
        storePath,
        'index_expression_mismatch',
        `Expression index "${indexName}" does not match the current routing schema.`,
      )
    }
  }

  const indexValues = requiredIndexNames.map(() => '(?)').join(',')
  let indexColumnRows
  try {
    indexColumnRows = db.prepare(`
      WITH required(name) AS (VALUES ${indexValues})
      SELECT required.name AS index_name, column.seqno, column.name,
        column.desc, column.coll
      FROM required
      JOIN pragma_index_xinfo(required.name) AS column
      WHERE column."key"=1
      ORDER BY required.name, column.seqno
    `).all(...requiredIndexNames)
  } catch (error) {
    throw routingStoreAdmissionError(
      storePath,
      'index_schema_unreadable',
      `SQLite could not inspect required index columns (${error instanceof Error ? error.message : String(error)}).`,
    )
  }
  const columnsByIndex = new Map(requiredIndexNames.map((name) => [name, []]))
  for (const column of indexColumnRows) {
    columnsByIndex.get(String(column.index_name))?.push(
      `${column.name === null ? '<expression>' : String(column.name)}:${Number(column.desc)}:${String(column.coll ?? '').toUpperCase()}`,
    )
  }
  for (const [indexName, contract] of Object.entries(routingStoreIndexContract)) {
    if (!requiredIndexNames.includes(indexName)) continue
    const actualColumns = columnsByIndex.get(indexName) ?? []
    const matchesCurrentColumns = actualColumns.length === contract.columns.length
      && actualColumns.every((column, index) => column === contract.columns[index])
    if (!matchesCurrentColumns) {
      throw routingStoreAdmissionError(
        storePath,
        'index_columns_mismatch',
        `Index "${indexName}" columns are ${JSON.stringify(actualColumns)}; expected ${JSON.stringify(contract.columns)}.`,
      )
    }
  }
  ...
  try {
    const rows = db.prepare(`
      SELECT key, value, length(CAST(key AS BLOB)) AS key_bytes,
        length(CAST(value AS BLOB)) AS value_bytes
      FROM metadata
      ORDER BY key
      LIMIT ?
    `).all(routingStoreMetadataMaxRows + 1)
    if (rows.length > routingStoreMetadataMaxRows) {
      throw routingStoreAdmissionError(
        storePath,
        'metadata_budget_exceeded',
        `Metadata contains more than ${routingStoreMetadataMaxRows} rows.`,
      )
    }
    let totalBytes = 0
    const entries = []
    for (const row of rows) {
      const keyBytes = Number(row.key_bytes ?? 0)
      const valueBytes = Number(row.value_bytes ?? 0)
      totalBytes += keyBytes + valueBytes
      if (
        keyBytes > routingStoreMetadataMaxKeyBytes
        || valueBytes > routingStoreMetadataMaxValueBytes
        || totalBytes > routingStoreMetadataMaxTotalBytes
      ) {
        throw routingStoreAdmissionError(
          storePath,
          'metadata_budget_exceeded',
          `Metadata exceeds the ${routingStoreMetadataMaxTotalBytes}-byte bounded admission budget.`,
        )
      }
      try {
        entries.push([row.key, JSON.parse(row.value)])
      } catch {
        throw routingStoreAdmissionError(
          storePath,
          'metadata_malformed',
          `Metadata value for ${JSON.stringify(row.key)} is not valid JSON.`,
        )
      }
    }
    metadata = Object.fromEntries(entries)
  } catch (error) {
    if (error?.code === 'VIGO_ROUTING_STORE_ADMISSION_FAILED') throw error
    throw routingStoreAdmissionError(
      storePath,
      'metadata_unreadable',
      `SQLite could not read bounded metadata (${error instanceof Error ? error.message : String(error)}).`,
    )
  }
  ...
  return {
    ...
    admission: Object.freeze({
      ...
      metadataBudgetBytes: routingStoreMetadataMaxTotalBytes,
...
function staticTopologySourceFingerprint(metadata) {
  return crypto.createHash('sha256').update(JSON.stringify({
    fingerprintVersion: staticTopologySourceFingerprintVersion,
...
function staticTopologySourceStorageIdentity(storePath) {
  ...
  try {
    ...
    return crypto.createHash('sha256').update(JSON.stringify({
      version: 'vigo.routing.source-storage-identity.v2',
      // Metadata alone cannot detect an in-place timetable edit that leaves
      // the declared counts unchanged. Bind the resident cache namespace to
      // the immutable SQLite file boundary as well.
      storageStatSignature: sqliteStoreStatSignature(storePath),
      storeId: metadata.storeId ?? null,
      schemaVersion: metadata.schemaVersion ?? null,
      builtAt: metadata.builtAt ?? metadata.generatedAt ?? null,
      sourceFingerprint: metadata.sourceFingerprint ?? null,
      connectionCount: Number(metadata.connectionCount ?? -1),
      transferCount: Number(metadata.transferCount ?? -1),
      transferSemanticsVersion: metadata.transferSemanticsVersion ?? null,
      transferGeneration: Number(metadata.transferGeneration ?? -1),
      stopCount: Number(metadata.stopCount ?? -1),
      bridgedUntimedGapCount: Number(metadata.bridgedUntimedGapCount ?? -1),
    })).digest('hex')
  } finally {
...
function staticTopologySourceStorageSnapshot(storePath) {
  // The boundary digest remains the authoritative identity. The stat
  // signature is only a cheap change detector for resident immutable stores;
  // require it to remain stable across the digest so a concurrent replacement
  // can never be accepted as the cached baseline.
  for (let attempt = 0; attempt < 3; attempt += 1) {
    const statSignature = sqliteStoreStatSignature(storePath)
    const identity = staticTopologySourceStorageIdentity(storePath)
    if (sqliteStoreStatSignature(storePath) === statSignature) {
      return { identity, statSignature }
    }
  }
  throw new Error('Routing store changed repeatedly while its source identity was being read.')
}

function streetStoreMetadataEvidence(storePath) {
  let db
  try {
    db = new DatabaseSync(storePath, { readOnly: true })
    const rows = db.prepare(`
    ...
    // The identity must still change for a replaced corrupt/missing store so a
    // previously cached plan cannot hide the authoritative open-time failure.
    return {
      unreadable: true,
      errorCode: String(error?.code ?? error?.name ?? 'street_store_metadata_error'),
    }
  } finally {
    try { db?.close() } catch {}
  }
...
function streetStoreStorageSnapshot(storePath) {
  const resolvedPath = path.resolve(storePath)
  // A stat-only check is the hot path. Once it changes, bind the new cache
  // namespace to both storage evidence and the PBF content fingerprint. The
  // before/after signatures prevent accepting a concurrently replaced store.
  for (let attempt = 0; attempt < 3; attempt += 1) {
    const statSignature = sqliteStoreStatSignature(resolvedPath)
    const evidence = {
      version: 'vigo.street.storage-identity.v2',
      metadata: streetStoreMetadataEvidence(resolvedPath),
    }
    if (sqliteStoreStatSignature(resolvedPath) === statSignature) {
      return {
        identity: crypto.createHash('sha256').update(stableJson(evidence)).digest('hex'),
        statSignature,
      }
    }
  }
...
function currentStaticTopologySourceStorageIdentity(store) {
  if (sqliteStoreStatSignature(store.storePath) === store.sourceStorageStatSignature) {
    return store.sourceStorageIdentity
  }
  const snapshot = staticTopologySourceStorageSnapshot(store.storePath)
  if (snapshot.identity === store.sourceStorageIdentity) {
    // A metadata-only timestamp/inode observation can leave the authoritative
    // boundary digest unchanged. Adopt its stable signature so later requests
    // return to the stat-only fast path rather than rehashing forever.
    store.sourceStorageStatSignature = snapshot.statSignature
  }
  return snapshot.identity
}
...
function inspectStaticTopologyDatabase(db) {
  ...
  if (metadata.staticTopologySourceFingerprint !== sourceFingerprint) {
...
export async function refreshNationalGtfsDerivedArtifacts(storePath, options = {}) {
  const resolvedStorePath = path.resolve(storePath)
...
function rebuildStopAccessRoles(db) {
  ...
  db.exec(`
    ...
    SELECT stop_id, MAX(can_board), MAX(can_alight)
    FROM (
      SELECT connection.from_stop_id AS stop_id, 1 AS can_board, 0 AS can_alight
      FROM connections AS connection INDEXED BY connections_from_departure_cover
      ${permissionJoin}
      WHERE ${hasConnectionPermissions ? 'COALESCE(permission.can_board, 1)' : '1'}=1
      GROUP BY connection.from_stop_id
      UNION ALL
      SELECT connection.to_stop_id AS stop_id, 0 AS can_board, 1 AS can_alight
      FROM connections AS connection
      ${permissionJoin}
      WHERE ${hasConnectionPermissions ? 'COALESCE(permission.can_alight, 1)' : '1'}=1
      GROUP BY connection.to_stop_id
    )
    GROUP BY stop_id;
  `)
  ...
  try {
    ...
    if (metadata.departureIndexState === 'deferred') {
      const error = new Error(
        'The compacted GTFS store has no raw SQL departure index; rebuild the city from its GTFS source to refresh stop-access roles.',
      )
      error.code = 'raw_sql_departure_index_required'
      throw error
    }
...
export async function buildRoutingStoreFromSchedules({ schedules, outputPath, onProgress }) {
  ...
  try {
    ...
    db.close()
    const stagedStaticTopology = await buildDefaultStaticTopologySidecar(tempPath, outputPath, onProgress)
    const staticTopology = await publishRoutingStoreWithSidecar(tempPath, outputPath, stagedStaticTopology)
    ...
    await Promise.all([
      ...
      fsp.rm(`${nationalStaticTopologySidecarPath(outputPath)}.next`, { force: true }),
      fsp.rm(`${nationalStaticTopologySidecarPath(outputPath)}.next.building`, { force: true }),
    ])
    throw error
  }
}
...
export async function mergeNationalGtfsStores({ stores, outputPath, onProgress, removeSourcesAfterMerge = false }) {
  ...
  for (const descriptor of descriptors) {
    ...
    if (!/^[a-f0-9]{64}$/.test(String(metadata.sourceFingerprint ?? ''))) {
      throw new Error(`Routing store lacks a 0.1.4 source fingerprint and must be rebuilt from raw GTFS: ${descriptor.storePath}`)
    }
  ...
  try {
    ...
    const sourceFingerprint = crypto.createHash('sha256').update(stableJson(descriptors.map((descriptor, index) => ({
...
export function inspectNationalStaticTopologySidecar(storePath, sidecarPath = nationalStaticTopologySidecarPath(storePath)) {
  ...
  try {
    const sourceFingerprint = staticTopologySourceFingerprint(metadataRecord(sourceDb))
    ...
    if (metadata.staticTopologySourceStorageIdentity !== sourceStorageIdentity) {
      return { ready: false, reason: 'source_storage_mismatch', version: staticTopologySchemaVersion, sidecarPath: resolvedSidecarPath }
    }
    return {
      ready: true,
      reason: 'ready',
...
function populateStaticTopology(sourceDb, targetDb, { expectedConnections = 1, onProgress } = {}) {
  ...
  // The existing covering index is already ordered by from_stop_id. Aggregating
  // one origin at a time avoids both a huge GROUP BY temp file and a giant JS map.
  for (const row of sourceDb.prepare(`
    SELECT from_stop_id, to_stop_id, departure, arrival
    FROM connections INDEXED BY connections_from_departure_cover
...
export async function buildNationalStaticTopologySidecar({ storePath, outputPath, onProgress, minimumFreeBytes, force = false }) {
  ...
  try {
    sourceDb.exec(`PRAGMA query_only=ON; PRAGMA mmap_size=${readOnlySqliteMmapBytes}; PRAGMA cache_size=-${readOnlySqliteCacheKiB};`)
    ...
    upsertStaticTopologyMetadata(targetDb, {
      ...
      staticTopologySourceFingerprintVersion,
...
function stopAccessIndexDiagnostics(store) {
  ...
  return {
    ...
    queryMs: Number(index.queryMs.toFixed(3)),
  }
}
...
function routingSemanticsFromMetadata(metadata, hasConnectionPermissions) {
  ...
  const sourceContentFingerprint = metadata.sourceFingerprint ?? metadata.storeId ?? null
  ...
  const routingDataSemantics = immutableJsonSnapshot({
    sourceFingerprint: sourceContentFingerprint,
...
function openNationalStore(storePath, options = {}) {
  ...
  const state = {
    ...
    sourceFingerprint: staticTopologySourceFingerprint(metadata),
    sourceContentFingerprint,
    blockingRoutingFeatures,
    routingLimitations,
    routingCoverage,
    ...
    transferGeneration,
    hasConnectionPermissions,
    sourceStorageIdentity: sourceStorageSnapshot.identity,
    sourceStorageStatSignature: sourceStorageSnapshot.statSignature,
    ...
    accessibilityTargetCache: new Map(),
    ...
    routeResultCache: new WeightedLruCache(routeResultCacheLimits),
    stopLookup: null,
...
export function prepareNationalGtfsStore(storePath) {
  ...
  return {
    ...
    resolvedTransferEdges: store.resolvedTransferCount,
    sourceContentFingerprint: store.sourceContentFingerprint,
  ...
  try {
    ...
    for (let index = 0; index + 1 < calibrationAnchors.length; index += 1) {
      ...
      plans.push({
        ...
        engineQueryMs: plan.diagnostics?.searchStats?.engineQueryMs ?? null,
        accessPreparationMs:
          plan.diagnostics?.searchStats?.accessPreparationMs ?? null,
        materializationMs:
          plan.diagnostics?.searchStats?.materializationMs ?? null,
      })
    }
    return {
      ready: true,
...
export function prepareNationalGtfsRoutingContext(storePath, options = {}) {
  ...
  if (options.serviceDate) {
    serviceDateResolution = resolveServiceDate(
      store,
      options.serviceDate,
      options.serviceDay ?? 'weekday',
      options.allowServiceDateFallback === true,
    )
    const services = activateServices(store, serviceDateResolution.resolvedServiceDate, options.serviceDay ?? 'weekday')
    ...
    activeServiceKernel = requiredServiceCoverageIncomplete(options, serviceDateResolution)
      ...
      : prepareActiveServiceKernel(store, services, store.activeServiceDate)
...
function resolveServiceDate(store, requestedServiceDate, serviceDay = 'weekday', allowFallback = false) {
...
function serviceAccessAnchorProfile(
  ...
  const profileIdentity = crypto.createHash('sha256').update(stableJson({
    schemaVersion: 'vigo.routing.service-access-anchor-profile.v1',
    sourceContentFingerprint: metadata.sourceFingerprint ?? metadata.storeId ?? null,
    sourceStorageIdentity,
    stopAccessRoleIndexVersion: metadata.stopAccessRoleIndexVersion,
    retainedRoleCount,
    anchors: longitudes.length,
    originAnchorCount,
...
function lightweightIncompleteCoveragePlan(
  ...
  const streetSearchMs = directWalkEligible
    ...
    : 0
  if (
    staticTopologySourceStorageSnapshot(resolvedStorePath).identity
    !== sourceStorageIdentity
  ) return null
  if (directPath) {
    ...
    return {
      ...
      diagnostics: {
        ...
        searchStats: {
          ...
          cacheHit: false,
          resultCachePolicy: request.__disableResultCache === true
            ? 'disabled'
            : 'enabled',
        },
      },
  ...
  try {
    ...
    if (!incompleteServiceCoverage && directWalkEligible) {
      anchorProfile = serviceAccessAnchorProfile(
        ...
        resolvedStorePath,
        metadata,
        sourceStorageSnapshot.identity,
      )
    }
  } finally {
    try { db?.close() } catch {}
  ...
  const verifiedPath = routed.directWalkPathChecked
    ...
    ? Number.isFinite(routed.directWalkDistanceKm)
      ? {
          ...
          nativeQueryMs: routed.directWalkQueryMs,
  ...
  return {
    ...
    diagnostics: {
      ...
      searchStats: {
        ...
        directWalkFallbackNativeQueryMs: path.nativeQueryMs,
      ...
      directWalkFallback: {
        streetSearchMs,
        streetPathReused,
        nativeQueryMs: path.nativeQueryMs,
        ...
        transitSearchQueryMs: numeric(transitPlan?.diagnostics?.searchStats?.queryMs, null),
      },
    },
  }
}
...
function transitDominatingDirectWalkPlan(
  ...
  // The strict point objective is lexicographic in (arrival, boardings).
...
function pointToAccessCoordinates(
  ...
  if (candidate.nativeStreetPath) {
    const coordinates = []
    appendDistinctCoordinate(coordinates, pointCoordinate)
...
function pruneNativeAccessProfileSnapshots(storePath, currentSnapshotPath) {
  ...
  const directory = path.dirname(resolvedStorePath)
  const prefix = `${path.basename(resolvedStorePath)}.native-access-profile.`
  const staleTemporaryCutoffMs = Date.now() - 10 * 60 * 1000
  const removed = []
  const snapshots = []
  for (const entry of fs.readdirSync(directory, { withFileTypes: true })) {
    ...
    if (entry.name.includes('.bin.') && entry.name.endsWith('.tmp')) {
      if (stats.mtimeMs >= staleTemporaryCutoffMs) continue
      fs.rmSync(artifactPath, { force: true })
      removed.push({ path: artifactPath, bytes: stats.size, reason: 'stale-temporary' })
      continue
    }
  ...
  for (const snapshot of snapshots) {
    const retain = snapshot.current || (
      retainedCount < nativeAccessProfileSnapshotCacheMaxEntries
      && retainedBytes + snapshot.bytes <= nativeAccessProfileSnapshotCacheMaxBytes
    )
    if (retain) {
      retainedCount += 1
...
function nativeCoordinateAccessProfile(store, streetStorePath, streetStorageIdentity) {
  ...
  if (!profile) {
    ...
    const profileKey = crypto.createHash('sha256').update(JSON.stringify({
      version: 'vigo.native-coordinate-access-profile.v8-local-graph-frontier-no-target-buckets',
      sourceStorageIdentity: store.sourceStorageIdentity,
      streetStorageIdentity,
      anchors: anchorLons.length,
      members: members.length,
      stops: stopIds.length,
      transfers: transferFromStopKeys.length,
      accessPolicy: nationalRoutingAccessPolicyIdentity,
    })).digest('hex')
    profile = {
      profileKey,
      stopIds,
...
function nativeStopTransferProfile(store, streetStorePath, streetStorageIdentity) {
  const members = []
  const memberLons = []
  const memberLats = []
  const memberOriginEligible = []
  ...
  const profileKey = crypto.createHash('sha256').update(JSON.stringify({
    version: 'vigo.native-stop-transfer-profile.v1',
    sourceStorageIdentity: store.sourceStorageIdentity,
    streetStorageIdentity,
    members: members.map((member, index) => [
      ...
      memberLons[index],
      memberLats[index],
      memberOriginEligible[index],
      memberDestinationEligible[index],
    ]),
  })).digest('hex')
  const profile = {
    profileKey,
...
function osmStopTransferGraphFingerprint(metadata, streetStorageIdentity, options) {
  return crypto.createHash('sha256').update(JSON.stringify({
...
export async function ensureNationalGtfsOsmStopTransfers(
  ...
  try {
    ...
    expectedFingerprint = osmStopTransferGraphFingerprint(
      metadata,
      streetStorageIdentity,
    ...
    `).get()?.count ?? 0)
    if (
      metadata.osmStopTransferGraph?.fingerprint === expectedFingerprint
...
function prepareNativeCoordinateAccessPair(
  ...
  const originPostprocessing = {
    ...
    native: true,
    totalMs: Number(routed.diagnostics.originAccessReductionMs.toFixed(3)),
  ...
  const destinationPostprocessing = {
    engine: routed.diagnostics.accessReducer,
    native: true,
    totalMs: Number(routed.diagnostics.destinationAccessReductionMs.toFixed(3)),
...
function nativeCoordinateAccessPairForRequest(
  ...
  if (!prepared) {
    return prepareNativeCoordinateAccessPair(
      ...
      streetStorePath,
      streetStorageIdentity,
      request?.__disableResultCache === true,
    )
  }
...
export function inspectNationalGtfsAccessCandidates(storePath, point, options = {}) {
  ...
  return {
    ...
    diagnostics: {
      ...
      queryMsDelta: Number((after.queryMs - before.queryMs).toFixed(3)),
...
function activateServices(store, serviceDate, serviceDay = 'weekday') {
  ...
  const serviceSetKey = `services:${services.size}:${crypto.createHash('sha256')
    .update(JSON.stringify([...services].sort()))
    .digest('hex')}`
...
function preloadNativeTimetableKernel(kernel) {
  ...
  const diagnostics = {
    ready: true,
    configureMs: prepared.configureMs,
    ...prepared.diagnostics,
  }
...
function pruneActiveServiceKernelSnapshotCache(storePath, currentSnapshotPath) {
  ...
  for (const entry of fs.readdirSync(directory, { withFileTypes: true })) {
    ...
    if (entry.name.includes('.bin.') && entry.name.endsWith('.tmp')) {
      ...
      fs.rmSync(artifactPath, { force: true })
      removed.push({ path: artifactPath, bytes, reason: 'orphan-temporary' })
      continue
    }
    if (!entry.name.endsWith('.bin')) continue
    const stats = fs.statSync(artifactPath)
  ...
  let retainedBytes = 0
  for (const snapshot of snapshots) {
    const fits = snapshot.current || (
      retainedCount < activeServiceKernelSnapshotCacheMaxEntries
      && retainedBytes + snapshot.bytes <= activeServiceKernelSnapshotCacheMaxBytes
    )
    if (fits) {
      retainedCount += 1
      retainedBytes += snapshot.bytes
...
function loadPersistedActiveServiceKernel(store, serviceKey, snapshotPath) {
  ...
  try {
    ...
    if (
      ...
      || persisted?.sourceStorageIdentity !== store.sourceStorageIdentity
...
function activeServiceKernelArriveByCandidates(
  kernel,
  originSeeds,
  earliest,
  deadline,
  ...
  // Keep this projection byte-for-byte equivalent to route_arrive_by_csa in
  // the Rust kernel.  It is used only when the scalar boundary's itinerary is
  // rejected by the public returned-station-cycle contract, so JavaScript can
  // certify the complete fallback frontier instead of silently changing the
  // timetable objective.
...
function searchActiveServiceKernelNativeRealtime(
  ...
  const queryMs = Number(raw.queryMs ?? raw.queryNs / 1e6)
  return {
    ...
    scalarPhases: {
      compileMs: numeric(raw.compileMs, 0),
      scanMs: numeric(raw.scanMs, 0),
      chainMs: 0,
    },
    heuristicMode: 'none',
    nativeTimetableKernel: {
      source: 'rust_node_api_query_scoped_gtfs_rt_trip_update_overlay',
      configureMs: raw.configureMs,
      queryMs: Number(queryMs.toFixed(3)),
...
function activeServiceKernelSearchFromNativeScalar(kernel, raw, metadata = raw) {
  ...
  return {
    ...
    explicitTransferChecks: raw.explicitTransferChecks,
    scalarPhases: {
      destinationSeedMs: Number(raw.destinationSeedNs ?? 0) / 1e6,
      originSeedMs: Number(raw.originSeedNs ?? 0) / 1e6,
      scanMs: Number(raw.scanNs ?? 0) / 1e6,
      chainMs: Number(raw.chainNs ?? 0) / 1e6,
    },
    heuristicMode: 'none',
    nativeTimetableKernel: {
      source: 'rust_node_api_zero_copy_active_service_arrays',
      configureMs: metadata.configureMs,
      queryMs: Number(queryMs.toFixed(3)),
...
export function routeNativeParetoWithRestrictionFallback(routePareto, kernel, nativeRequest) {
  ...
  if (
    ...
    restrictionFallback = {
      ...
      primaryQueryMs: Number(restrictedRaw.queryMs.toFixed(3)),
      fallbackQueryMs: Number(raw.queryMs.toFixed(3)),
  ...
  return {
    raw,
    restrictionFallback,
    combinedQueryMs: Number((restrictedRaw.queryMs + (restrictionFallback ? raw.queryMs : 0)).toFixed(3)),
  }
}
...
function searchActiveServiceKernelNativePareto(
  ...
  return {
    ...
    queryMs: combinedQueryMs,
    corridorMs: Number(raw.corridorMs.toFixed(3)),
    forwardMs: Number(raw.forwardMs.toFixed(3)),
    reverseMs: Number(raw.reverseMs.toFixed(3)),
    roundMs: Number(raw.roundMs.toFixed(3)),
...
function activeServiceKernelUnmaterializedSearchStats(store, search, context) {
  ...
  const kernelSnapshot = activeServiceKernelSnapshot(store)
  return {
    engineInvocationsThisPass: { rustTimetable: 1, sqlite: 0 },
    queryMs: Number((performance.now() - startedAt).toFixed(3)),
    engineQueryMs: search.queryMs,
    ...
    activeServiceKernel: {
      ...
      lexicographicCertified: lexicographicCertifier,
  ...
  for (const step of chain) {
    ...
    if (step.kind === 'transfer') {
      ...
      legs.push({
        ...
        nativeStreetQueryMs: transferPath?.nativeQueryMs,
      })
      continue
    }
    ...
    diagnostics: {
      ...
      optimality: realtimeAdjustedRideCount
        ...
        : lexicographicCertifier
          ? 'lexicographic_earliest_arrival_then_boardings_within_active_service_and_access_model'
      ...
      searchStats: {
        ...
        nativeStreetPathQueryMs: Number(nativeStreetPathDiagnostics.queryMs.toFixed(3)),
...
function normalizedAccessibilityScenarioOverlay(value) {
  if (!value || typeof value !== 'object' || Array.isArray(value)) return null
  const stops = Array.isArray(value.stops) ? value.stops.map((stop, index) => {
    ...
    if (coordinate.length !== 2 || !coordinate.every(Number.isFinite)) {
      throw new Error(`Accessibility scenario overlay stop ${index} has an invalid coordinate.`)
    }
    return {
  ...
  if (stops.length > 256) {
    throw new Error('Accessibility scenario overlays are limited to 256 stops.')
  }
  ...
  if (
    ...
    throw new Error('Accessibility scenario overlay service arrays are inconsistent.')
  }
  return {
    stops,
    directionOffsets,
...
function normalizedAccessibilitySurface(value) {
  if (!value || typeof value !== 'object' || Array.isArray(value)) return null
  ...
  if (
    ...
    throw new Error('Accessibility surface requires valid bounds and 1-1024 pixel dimensions.')
  }
  return {
    bounds,
    width,
...
function buildAccessibilitySurface(
  streetStorePath,
  surfaceRequest,
  seeds,
  maxWalkKm,
  ...
  if (!streetStorePath) {
    throw new Error('Accessibility surfaces require a persisted OSM street store.')
  }
  ...
  const surface = rasterNativeStreetSurface(streetStorePath, {
    ...
    // Accessibility owns the complete directed OSM edge surface. Native code
...
function annotateAccessibilitySurface(surface, { transitSeedCount = 0, scenarioSeedCount = 0 } = {}) {
  ...
  return {
    ...
    diagnostics: {
      ...
      transitSeedCount,
      scenarioSeedCount,
      edgeEvidenceSelection: 'all-reached-directed-edges',
    },
  }
}
...
function accessibilityTransitStatus({
  services,
  activeKernel,
  departure,
  horizon,
...
/**
 * Exact Accessibility range over the one resident timetable image. Free
 ...
 */
export function routeNationalGtfsAccessibilityRange(storePath, request, options = {}) {
  const started = performance.now()
  const onProgress = options.onProgress
  const isCancelled = options.isCancelled
  const checkCancelled = () => {
    if (!isCancelled?.()) return
    const error = new Error('Accessibility analysis was cancelled.')
  ...
  if (origin.length !== 2 || !origin.every(Number.isFinite)) {
    throw new Error('Accessibility analysis requires a valid origin coordinate.')
  }
  const departureMinutes = numeric(request.departMinutes, 8 * 60)
  if (departureMinutes < 0 || departureMinutes > 2_880) {
    throw new Error('departMinutes is outside the supported GTFS time range.')
  }
  ...
  const scenarioOverlay = normalizedAccessibilityScenarioOverlay(request.scenarioOverlay)
  const surfaceRequest = normalizedAccessibilitySurface(request.surface)
  ...
  if (store.blockingRoutingFeatures.length) {
    const error = new Error('Accessibility analysis cannot route unsupported GTFS features.')
  ...
  if (requiredServiceCoverageIncomplete(request, serviceDateResolution)) {
    const error = new Error('Accessibility analysis requires complete service coverage for the selected date.')
  ...
  if (!activeKernel) {
    ...
    if (
      ...
      && store.activeServiceKernel?.serviceKey === store.activeServiceDate
      && store.activeServiceKernel?.sourceStorageIdentity === store.sourceStorageIdentity
    ) activeKernel = store.activeServiceKernel
  }
  ...
  if (!activeKernel) {
    if (!services.size) {
      ...
      const surface = annotateAccessibilitySurface(buildAccessibilitySurface(
        streetStorePath,
        surfaceRequest,
      ...
      const transit = accessibilityTransitStatus({
        services,
        activeKernel: null,
        departure,
        horizon,
      ...
      return {
        ...
        diagnostics: {
          ...
          surface: surface ? {
            ...surface.diagnostics,
            owner: 'rust_resident_accessibility_pipeline',
    ...
    const error = new Error(
      `Resident timetable kernel is required for Accessibility: ${store.activeServiceKernelStatus?.detail ?? store.activeServiceKernelStatus?.reason ?? 'unavailable'}`,
    )
  ...
  store.accessibilityTargetCache ??= new Map()
  let targetSelection = boundedCacheGet(
    store.accessibilityTargetCache,
    targetSelectionKey,
  )
  ...
  if (!targetStops.length && !scenarioOverlay?.stops.length) {
    report('surface', 0.76, 'Building the Accessibility-owned pedestrian surface')
    const surfaceStarted = performance.now()
    const surface = annotateAccessibilitySurface(buildAccessibilitySurface(
      streetStorePath,
      surfaceRequest,
    ...
    return {
      ...
      diagnostics: {
        ...
        transit: accessibilityTransitStatus({
          services,
          activeKernel,
          departure,
          horizon,
  ...
  if (scenarioOverlay?.stops.length) {
    if (!streetStorePath) {
      throw new Error('Accessibility scenario overlays require a persisted OSM street store.')
    }
    const streetStorageIdentity = currentStreetStoreStorageIdentity(streetStorePath)
    ...
    let endpointFrontierQueryMs = originAccess?.diagnostics?.queryMs ?? 0
    for (let overlayStop = 0; overlayStop < scenarioOverlay.stops.length; overlayStop += 1) {
      ...
      endpointFrontierQueryMs += fromOverlay.diagnostics.queryMs + toOverlay.diagnostics.queryMs
    ...
    if (matrix?.size !== scenarioOverlay.stops.length || matrix.directed !== true) {
      throw new Error('Accessibility scenario overlay received an invalid directed street matrix.')
    }
    ...
    overlayDiagnostics = {
      ...
      compileMs: Number(routed.compileMs.toFixed(3)),
      scanMs: Number(routed.scanMs.toFixed(3)),
      ...
      connectorAggregateCchQueryMs: Number(
        Number(connectors.diagnostics?.aggregateCchQueryMs ?? 0).toFixed(3),
      ),
      connectorMatrixCchAccelerated:
        connectors.diagnostics?.matrixCchAccelerated === true,
      connectorMatrixCchQueryMs: Number(
        Number(connectors.diagnostics?.matrixCchQueryMs ?? 0).toFixed(3),
      ),
      endpointFrontierCalls,
      endpointFrontierQueryMs: Number(endpointFrontierQueryMs.toFixed(3)),
  ...
  return {
    ...
    diagnostics: {
      ...
      timetable: {
        ...
        compileMs: activeKernel.compileMs,
        residentPrepareMs: Number(residentPrepareMs.toFixed(3)),
      ...
      search: {
        ...
        nativeQueryMs: Number((Number(timetable.queryNs ?? 0) / 1e6).toFixed(3)),
...
export function routeNationalGtfsMatrix(storePath, request) {
  ...
  const matrixStrategy = requestedStrategy === 'auto'
    ? (
        activeKernel && uniqueDestinations.length >= sharedMatrixDestinationThreshold
          ? 'shared'
          : 'pairwise'
      )
    : requestedStrategy
  if (matrixStrategy === 'pairwise') {
    ...
    return {
      ...
      diagnostics: {
        ...
        serviceDateFallbackPolicy: representativeSnapshot ? 'representative-snapshot' : 'exact',
        ...serviceDateDiagnostics(serviceDateResolution),
        scannedDepartures: plans.flat().reduce((sum, plan) => sum + Number(plan.diagnostics?.scannedDepartures ?? 0), 0),
        relaxedStops: plans.flat().reduce((sum, plan) => sum + Number(plan.diagnostics?.relaxedStops ?? 0), 0),
        queryMs: Number((performance.now() - started).toFixed(3)),
      },
    }
  }
  ...
  for (let originIndex = 0; originIndex < origins.length; originIndex += 1) {
    ...
    for (let destinationIndex = 0; destinationIndex < destinations.length; destinationIndex += 1) {
      ...
      rows.push({
        originIndex,
        destinationIndex,
        status: Number.isFinite(arrival) ? 'ready' : 'blocked',
        departMinutes: departureMinutes,
        arriveMinutes: Number.isFinite(arrival) ? minuteCoordinate(arrival) : null,
        durationMinutes: Number.isFinite(arrival) ? secondsToMinutes(arrival - departure) : null,
      })
    }
  }
  return {
    ...
    diagnostics: {
      ...
      serviceDateFallbackPolicy: representativeSnapshot ? 'representative-snapshot' : 'exact',
      ...serviceDateDiagnostics(serviceDateResolution),
      scannedDepartures: searchResults.reduce((sum, result) => sum + result.scanned, 0),
      upperBoundSeedScans: searchResults.reduce((sum, result) => sum + result.seedScanned, 0),
      seededDestinationUpperBounds: searchResults.reduce((sum, result) => sum + result.seededDestinationUpperBounds, 0),
      upperBoundedForwardSearches: searchResults.reduce((sum, result) => sum + (result.upperBounded ? 1 : 0), 0),
      relaxedStops: searchResults.reduce((sum, result) => sum + result.relaxed, 0),
      poppedStates: searchResults.reduce((sum, result) => sum + Number(result.poppedStates ?? 0), 0),
      expandedTripRuns: searchResults.reduce((sum, result) => sum + Number(result.expandedTripRuns ?? 0), 0),
      dominatedTripBoardings: searchResults.reduce((sum, result) => sum + Number(result.dominatedTripBoardings ?? 0), 0),
      engineQueryMs: Number(searchResults.reduce((sum, result) => sum + Number(result.queryMs ?? 0), 0).toFixed(3)),
      returnedStationCyclePolicy: 'represented',
...
function routeNationalGtfsArriveByStore(
  ...
  const requestLocalCoordinateAccess = prepareRequestLocalNativeCoordinateAccessPair(
    request,
    store,
    request.origin,
    request.destination,
  ...
  const nativeCoordinateAccess = requestLocalCoordinateAccess.accessPair
  const preparedArriveByCoordinateAccess = requestLocalCoordinateAccess.prepared
  const arriveByCoordinateAccessReuseStart =
    preparedArriveByCoordinateAccess?.reuseCount ?? 0
  const fallbackRetryWithPreparedCoordinateAccess = () => fallbackRetryRequest(
    store,
  ...
  if (!services.size) {
    ...
    if (retry) return routeNationalGtfsStore(storePath, retry)
    const blocked = blockedPlan(request, earliest / 60, maxWalkKm, 'No active service', `No GTFS service is active on ${serviceDateResolution.resolvedServiceDate}.`, { originStops: originStops.length, destinationStops: destinationStops.length }, serviceDateResolution)
    return { ...blocked, timePreference: 'arrive', choiceLabel: 'No arrive-by itinerary' }
  }
  let activeKernel = (
    store.activeServiceKernel?.serviceKey === store.activeServiceDate
  ...
  const decorate = (
    ...
    diagnostics: {
      ...
      algorithm: recoveredByDirectWalk
        ? 'rust_arrive_by_scalar_upper_bound_plus_osm_direct_walk_certificate'
        : forwardParityRecovery
          ? 'rust_arrive_by_scalar_boundary_plus_complete_public_candidate_recovery'
          : 'rust_exact_arrive_by_monotone_boundary_no_heuristic',
      optimality: recoveredByDirectWalk
        ...
        : forwardParityRecovery
          ...
          : 'latest_departure_guaranteed_by_exact_monotone_boundary_search_over_complete_initial_board_event_set',
      searchStats: {
        ...plan.diagnostics.searchStats,
        arriveByCandidateSource: 'rust_resident_departure_index',
        arriveByCandidates: boundary.candidateCount,
        arriveByVerifiedCandidates: boundary.verifiedCandidates,
        arriveBySearchStrategy: forwardParityRecovery
          ? 'rust_exact_monotone_boundary_plus_complete_public_candidate_recovery'
          : 'rust_exact_monotone_boundary_binary_search',
        arriveByNativeQueryMs: Number(boundary.queryMs.toFixed(3)),
        arriveByNativeEngineQueryMs: Number(boundary.engineQueryMs.toFixed(3)),
        ...
        arriveByFeasibilityInvariant:
          'waiting_at_origin_preserves_each_feasible_itinerary_for_every_earlier_departure',
  ...
  const arriveByOriginSeeds = activeServiceKernelAccessSeeds(kernel, originStops)
  const arriveByDestinationSeeds = activeServiceKernelAccessSeeds(kernel, destinationStops)
  const allowPreRideTransfers =
    !request.streetStorePath || Boolean(explicitRoutingStopId(request.origin))
  const nativeBoundary = routeNativeTimetableArriveBy(kernel, {
  ...
  if (Number.isFinite(latestFeasibleCandidateSeconds) && !latestFeasiblePlan) {
    const candidates = activeServiceKernelArriveByCandidates(
      kernel,
      arriveByOriginSeeds,
      earliest,
      deadline,
    ...
    if (
      candidates.length !== nativeBoundary.candidateCount
      || selectedCandidateIndex < 0
    ) {
      const error = new Error(
        'JavaScript arrive-by recovery could not reproduce the Rust candidate frontier.',
      )
      error.code = 'native_arrive_by_candidate_contract_mismatch'
    ...
    const recovery = {
      status: 'passed',
      trigger: 'native_scalar_boundary_failed_public_forward_materialization',
      exactness:
        'rust_candidate_frontier_reproduced_then_filtered_by_the_public_noncyclic_itinerary_contract',
  ...
  const arriveBySearchStats = {
    arriveByCandidates: nativeBoundary.candidateCount,
    arriveByCandidateSource: 'rust_resident_departure_index',
    arriveByVerifiedCandidates: nativeBoundary.verifiedCandidates,
    arriveBySearchStrategy: 'rust_exact_monotone_boundary_binary_search',
    arriveByNativeQueryMs: Number(nativeBoundary.queryMs.toFixed(3)),
    arriveByNativeEngineQueryMs: Number(nativeBoundary.engineQueryMs.toFixed(3)),
...
export function routeNationalGtfsStore(storePath, request) {
  ...
  const resultCacheDisabled = request.__disableResultCache === true || realtimeRoutingRequested
  const routingCoverage = store.routingCoverage
  const decorateResultCachePolicy = (plan) => {
    ...
    if (resultCacheDisabled && plan?.diagnostics?.searchStats) {
      // A cache-disabled query always owns this freshly materialized result.
      // Decorate it in place to avoid cloning the plan, diagnostics, and
      // search-stat objects solely to attach measurement metadata.
      ...
      Object.assign(plan.diagnostics.searchStats, {
        ...
        resultCache: routeResultCacheDiagnostics(store),
      })
      return plan
    }
    return {
      ...
      diagnostics: {
        ...
        searchStats: {
          ...plan?.diagnostics?.searchStats,
          queryMs: Number((performance.now() - routeStartedAt).toFixed(3)),
          resultCachePolicy: resultCacheDisabled ? 'disabled' : 'enabled',
          resultCache: routeResultCacheDiagnostics(store),
        },
      },
    }
  ...
  if (store.blockingRoutingFeatures.length) {
    ...
    return decorateResultCachePolicy(blockedPlan(
      request,
      selectedMinutes,
      maxWalkKm,
  ...
  if (directWalk) return decorateResultCachePolicy(directWalk)
  if (request.timePreference === 'arrive') {
    ...
    if (transitPreferredPlan.status === 'ready') {
      return decorateResultCachePolicy(transitPreferredPlan)
    }
    return decorateResultCachePolicy(
  ...
  try {
    ...
    const routeCacheKey = resultCacheDisabled
      ? null
      : [
          request.serviceDate,
          serviceDateResolution.resolvedServiceDate,
          serviceDateResolution.serviceDateFallbackApplied ? 'fallback-applied' : 'exact-date',
          request.allowServiceDateFallback === true ? 'fallback-allowed' : 'fallback-disabled',
          request.requireCompleteServiceCoverage === true ? 'complete-coverage-required' : 'partial-coverage-allowed',
          request.serviceDay ?? 'weekday',
          departure,
          normalizedHorizonMinutes.toFixed(3),
          pointKey(origin),
          origin.stopId ?? '',
          origin.source ?? '',
          origin.label ?? '',
          ...
          destination.label ?? '',
          maxWalkKm.toFixed(3),
          `direct-walk-limit:${directWalkEndToEndLimitKm(request).toFixed(3)}`,
          request.streetStorePath ?? 'direct',
          streetStorageIdentity,
          numeric(request.departureWindowMinutes, 0).toFixed(3),
          originAccessStopIds ? [...originAccessStopIds].sort().join(',') : '',
          destinationAccessStopIds ? [...destinationAccessStopIds].sort().join(',') : '',
          request.__disableDirectWalkDominance === true ? 'transit-only' : 'walk-competitive',
          `returned-station-cycle:${returnedStationCyclePolicy}`,
          `routing-preference:${request.routingPreference === 'balanced' ? 'balanced' : 'fastest'}`,
          `access-policy:${nationalRoutingAccessPolicyIdentity}`,
          'rust-exact-no-heuristic-v3',
        ].join('|')
    const cachedRoute = routeCacheKey === null ? undefined : store.routeResultCache.get(routeCacheKey)
    if (cachedRoute) return {
      ...decorateResultCachePolicy({
        ...cachedRoute,
        diagnostics: {
          ...cachedRoute.diagnostics,
          searchStats: {
            ...cachedRoute.diagnostics.searchStats,
            queryMs: Number((performance.now() - started).toFixed(3)),
            cacheHit: true,
          },
        },
    ...
    if (fusedCoordinateEligible) {
      ...
      const routed = routeNativeCoordinateTimetableScalar(
        ...
        residentFusedKernel,
        {
          ...
          disableCache: resultCacheDisabled,
        },
      )
    ...
    if (accessFrontierDirectWalk.plan) {
      if (!resultCacheDisabled) {
        store.routeResultCache.set(
          routeCacheKey,
          accessFrontierDirectWalk.plan,
          estimateRoutePlanWeight(accessFrontierDirectWalk.plan),
        )
      }
      return decorateResultCachePolicy(accessFrontierDirectWalk.plan)
    }
    ...
    let activeKernel = fusedCoordinateTimetable?.activeKernel ?? ((
      store.activeServiceKernel?.serviceKey === store.activeServiceDate
      && store.activeServiceKernel?.sourceStorageIdentity === store.sourceStorageIdentity
    ) ? store.activeServiceKernel : null)
    let serviceKernelPreparationMs = 0
    if (!activeKernel) {
      const serviceKernelPreparationStartedAt = performance.now()
      const status = prepareActiveServiceKernel(store, services, store.activeServiceDate)
      serviceKernelPreparationMs = Number(
        (performance.now() - serviceKernelPreparationStartedAt).toFixed(3),
      )
      if (
        status?.ready === true
        && store.activeServiceKernel?.serviceKey === store.activeServiceDate
    ...
    if (activeKernel) {
      ...
      try {
        ...
        const nativeTimetableKernel = {
          ...
          engineQueryMs: kernelSearch.queryMs,
        ...
        // (arrival, boardings) comparison. The full bounded Pareto pass remains
        ...
        if (requiresParetoCertification) {
          ...
          Object.assign(nativeTimetableKernel, {
            paretoSelected: true,
            engineQueryMs: Number(
              (kernelSearch.queryMs + paretoSearch.queryMs).toFixed(3),
            ),
        ...
        if (
          ...
          if (paretoSearch) {
            ...
            Object.assign(unmaterializedSearchStats, {
              engineQueryMs,
              acceleratorQueryMs: kernelSearch.queryMs,
              paretoCertificationQueryMs: paretoSearch.queryMs,
              paretoCorridorMs: paretoSearch.corridorMs,
              paretoForwardMs: paretoSearch.forwardMs,
              paretoReverseMs: paretoSearch.reverseMs,
              paretoRoundMs: paretoSearch.roundMs,
          ...
          if (earlyDirectComparison?.travelMode === 'walk') {
            if (!resultCacheDisabled) {
              store.routeResultCache.set(
                routeCacheKey,
                earlyDirectComparison,
                estimateRoutePlanWeight(earlyDirectComparison),
              )
            }
            return decorateResultCachePolicy(earlyDirectComparison)
          }
        }
        ...
        if (paretoSearch) {
          ...
          kernelPlan = {
            ...kernelPlan,
            choiceLabel: (
              kernelPlan.diagnostics?.balancedGeneralizedSelection?.selectedRole
              === 'nondominated_generalized_cost'
            ) || paretoSearch.transferPreferenceApplied === true
              ? 'Best balance'
              : kernelPlan.choiceLabel,
            diagnostics: {
              ...kernelPlan.diagnostics,
              optimality: kernelPlan.diagnostics?.balancedGeneralizedSelection
                ...
                : paretoSearch.transferPreferenceApplied === true
                  ...
                  : `lexicographic_earliest_arrival_then_boardings_certified_by_${certifierName}`,
              ...
              searchStats: {
                ...
                paretoRoundMs: paretoSearch.roundMs,
                paretoRestrictionFallback: paretoSearch.restrictionFallback,
                transferWork: activeServiceKernelTransferWorkPhases(
                  kernelSearch,
                  paretoSearch,
                ),
                activeServiceKernel: {
                  ...kernelPlan.diagnostics?.searchStats?.activeServiceKernel,
                  engineQueryMs,
                  paretoRestrictionFallback: paretoSearch.restrictionFallback,
                  transferWork: activeServiceKernelTransferWorkPhases(
                    kernelSearch,
        ...
        if (!resultCacheDisabled) {
          store.routeResultCache.set(
            routeCacheKey,
            visiblePlan,
            estimateRoutePlanWeight(visiblePlan),
          )
        }
        return decorateResultCachePolicy(visiblePlan)
      } catch (error) {
        store.activeServiceKernelStatus = {
          ...store.activeServiceKernelStatus,
  ...
  return {
    ...
    diagnostics: {
      ...
      searchStats: {
        ...
        queryMs: Number((numeric(firstPlan.diagnostics?.searchStats?.queryMs, 0) + numeric(secondPlan.diagnostics?.searchStats?.queryMs, 0)).toFixed(3)),
        componentSearches: 2,
      },
    },
  }
...
export function routeNationalGtfsDepartureWindow(storePath, request) {
  ...
  const centerMinutes = numeric(request.departMinutes, 8 * 60)
  const windowMinutes = Math.max(0, Math.min(30, Math.round(numeric(request.departureWindowMinutes, 10))))
  ...
  if (store.blockingRoutingFeatures.length) {
    ...
    const plans = sampleMinutes.map((sampleMinute) => ({
      ...
      id: stablePlanId('national-blocked-window', {
        sourceFingerprint: store.sourceContentFingerprint,
