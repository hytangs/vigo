...
window.runTests = async () => {
  ...
  return { stableLiveJourney: true, noExpiryLoop: true, explicitRerun: true, latestSnapshotOnInputChange: true, latestResponseWins: true, researchIsolation: true, streetIsolation: true, navigationRetention: true, cityInvalidation: true }
}
