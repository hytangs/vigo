...
const eventLabel: Record<Exclude<OperationalEvent['type'], 'headway-review'>, string> = { delay: 'Delay', bunching: 'Compressed interval', 'service-gap': 'Wider interval', cancellation: 'Cancellation', 'skipped-stop': 'Skipped stop', 'stale-data': 'Data freshness', 'service-alert': 'Service alert' }
