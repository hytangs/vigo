export const toolNames: Record<string, string> = { assess_service: 'Service assessment', service_timing: 'Vehicle timing', current_time: 'Current time', workspace_selection: 'Workspace selection', inspect_service: 'Service investigation', historical_baseline: 'Historical comparison', historical_runtime: 'Running-time study', operational_context: 'Operating references', reference_lookup: 'Public reference lookup', web_search: 'Public web search', web_read: 'Public source page', network_overview: 'Network and feed status', recall_notebook: 'Saved work and staff notes', resolve_entities: 'Stop and route lookup', place_search: 'Online place search', find_walk: 'Plan a walk with visits', walk_compare: 'Compare walks', walk_route: 'Walking route', gtfs_query: 'Timetable query', realtime_status: 'Current service reports', anomaly_scan: 'Departure comparisons', service_alerts: 'Agency alerts', route_plan: 'Journey calculation', reach: 'Reachable area', draft_rider_message: 'Rider message', service_profile: 'Scheduled service profile', stop_arrivals: 'Station arrival board' }
