...
import { allocateProjectTransportAtlasBudgets, compactTransportPreview, transportAtlasBudgets } from '../server/transport-atlas.mjs'
...
console.log(`Transport atlas contract passed (${compact.routes.length} routes, ${compact.stops.length} stops, ${shapePoints} shape points).`)
